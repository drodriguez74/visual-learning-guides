...
`https://<your-username>.github.io/lean-sixsigma-visual-guide/lean-six-sigma-guide.html`
...
| **Key Tools** | VSM, 5S, Kanban, Poka-Yoke, SIPOC, Fishbone, Pareto, Control Charts, FMEA, 5 Whys |
| **Belt Levels** | White → Yellow → Green → Black → Master Black Belt |
| **Interview Prep** | 7 common questions with expandable model answers + quick-reference cheat sheet |
...
- Six Sigma levels — DPMO, Cp/Cpk, CTQ, common vs special-cause variation
- Core tools: VSM, Fishbone, Pareto, Control Charts, FMEA, Poka-Yoke, SIPOC, 5 Whys, 5S, Kanban
